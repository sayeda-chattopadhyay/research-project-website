...
const ResearchSection = () => {
  ...
  return (
    <div className="mt-10 p-4 md:p-8 lg:p-12 flex flex-col md:flex-row gap-8 max-w-[1440px] mx-auto text-center">
      {/* text */}
      <div className="md:w-1/2 text-start md:pr-8">
        <h1 className="text-Raleway text-3xl font-bold mb-4">Our Research</h1>
        ...
        <Button text="Read More" className="mt-4" onClick={handleClick} />
      </div>
      {/* image */}
